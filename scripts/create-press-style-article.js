...
console.log('📰 Création d\'un article au style presse');
console.log('========================================\n');

// Article au style presse
const pressStyleArticle = [
  {
    id: "fr-cfo-1",
...
fs.writeFileSync(path.join(__dirname, '../data/blog/all.json'), JSON.stringify(pressStyleArticle, null, 2));
fs.writeFileSync(path.join(__dirname, '../data/blog/fr.json'), JSON.stringify(pressStyleArticle, null, 2));
fs.writeFileSync(path.join(__dirname, '../public/data/blog/all.json'), JSON.stringify(pressStyleArticle, null, 2));
fs.writeFileSync(path.join(__dirname, '../public/data/blog/fr.json'), JSON.stringify(pressStyleArticle, null, 2));

console.log('✅ Article au style presse créé !');
console.log('📰 Caractéristiques :');
console.log('   - Style journalistique et littéraire');
console.log('   - Moins de markdown (##, **)');
console.log('   - Paragraphes fluides et narratifs');
console.log('   - Sources citées en fin d\'article');
console.log('   - Ton professionnel et expert');
