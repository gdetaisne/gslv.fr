...
console.log('📊 Mise à jour avec de vrais graphiques SVG');
console.log('==========================================\n');

// Article avec vrais graphiques SVG
const articleWithRealCharts = [
  {
    id: "fr-cfo-1",
...
fs.writeFileSync(path.join(__dirname, '../data/blog/all.json'), JSON.stringify(articleWithRealCharts, null, 2));
fs.writeFileSync(path.join(__dirname, '../data/blog/fr.json'), JSON.stringify(articleWithRealCharts, null, 2));
fs.writeFileSync(path.join(__dirname, '../public/data/blog/all.json'), JSON.stringify(articleWithRealCharts, null, 2));
fs.writeFileSync(path.join(__dirname, '../public/data/blog/fr.json'), JSON.stringify(articleWithRealCharts, null, 2));

console.log('✅ Article mis à jour avec de vrais graphiques SVG !');
console.log('📊 Graphiques créés :');
console.log('   - /images/charts/startup-failure-causes.svg');
console.log('   - /images/charts/financial-reporting.svg');
console.log('   - /images/charts/fundraising-failures.svg');
